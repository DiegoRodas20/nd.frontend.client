...
@Component({
    selector: 'app-header-main-right',
    templateUrl: 'header-main-right.component.html',
    styleUrls: ['./header-main-right.component.scss'],
})

export class HeaderMainRightComponent implements OnInit {
