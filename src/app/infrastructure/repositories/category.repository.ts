    ...
    private categories: Category[] = [
        {
            id: 1,
            name: "Headphones",
            image: "assets/img/product/product-cat-1.png",
        ...
        },
        {
            id: 2,
            name: "Mobile Phone",
            image: "assets/img/product/product-cat-2.png",
        ...
        },
        {
            id: 3,
            name: "CPU Heat Pipes",
            image: "assets/img/product/product-cat-3.png",
            link: "shop-category.html",
            product_count: 57
        },
        {
            id: 4,
            name: "Smart Watch",
            image: "assets/img/product/product-cat-4.png",
            link: "shop-category.html",
            product_count: 44
        },
        {
            id: 5,
            name: "With Bluetooth",
            image: "assets/img/product/product-cat-5.png",
            link: "shop-category.html",
            product_count: 81
        }
    ]
